...
# 后台IP设置
Ipv4_ipaddr="192.168.6.1"            # 修改openwrt后台地址
Netmask_netm="255.255.255.0"           # IPv4 子网掩码
Op_name="Openwrt-鸭子"                   # 修改主机名称
...
# 旁路由选项
Gateway_Settings="0"       # IPv4 网关
DNS_Settings="0" # DNS 设置
Broadcast_Ipv4="0"                      # IPv4 广播
Disable_DHCP="0"                        # 关闭 DHCP
Disable_Bridge="0"                      # 去掉桥接模式
...
# 个性签名
Customized_Information="鸭子$(TZ=UTC-8 date '+%Y.%m.%d')"  # 个性签名
