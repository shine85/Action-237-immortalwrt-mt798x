...
sed -i '2i src-git homeproxy https://github.com/immortalwrt/homeproxy.git;main' feeds.conf.default
src-git homeproxy https://github.com/immortalwrt/homeproxy.git;main package/package/homeproxy
